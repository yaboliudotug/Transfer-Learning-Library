...
# CUDA_VISIBLE_DEVICES=1 python d_adapt.py --num-gpus 1 \
#   --config-file config/faster_rcnn_R_101_C4_voc.yaml \
...
#   OUTPUT_DIR logs/for_paper/faster_rcnn_R_101_C4/voc2watercolor/phase1 MODEL.ROI_HEADS.NUM_CLASSES 6 MODEL.WEIGHTS ${pretrained_models} SEED 0
...
#   OUTPUT_DIR logs/for_paper/faster_rcnn_R_101_C4/voc2comic/phase1 MODEL.ROI_HEADS.NUM_CLASSES 6 MODEL.WEIGHTS ${pretrained_models} SEED 0
...
#   OUTPUT_DIR logs/for_paper/faster_rcnn_R_101_C4/cityscapes2foggy_6/phase1 MODEL.WEIGHTS ${pretrained_models} SEED 0
