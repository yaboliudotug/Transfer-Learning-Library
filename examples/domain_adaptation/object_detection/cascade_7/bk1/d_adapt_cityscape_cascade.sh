...
CUDA_VISIBLE_DEVICES=0 python d_adapt.py --num-gpus 1 --workers-c 4 --max-train-c 20 --ignored-scores-c 0.05 0.5 --confidence-ratio-c 0.1 \
  ...
  --use-pre-cache 1 --use-pre-crop 1 --update-cache 1 --update-score 1 --update-proposal 1 \
  --num-cascade 3 --cascade-flag-category 111 --cascade-flag-bbox 111 \
  --ignored-scores-ls [[0.05,0.5],[0.05,0.5],[0.05,0.5]] --ignored-ious-ls [[0.4,0.5],[0.4,0.6],[0.4,0.7]] \
