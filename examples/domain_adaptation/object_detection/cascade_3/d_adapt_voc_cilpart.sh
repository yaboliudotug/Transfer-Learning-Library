...
CUDA_VISIBLE_DEVICES=0 python d_adapt.py --num-gpus 1 \
  ...
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/voc2clipart_2/phase1 MODEL.WEIGHTS ${pretrained_models} SEED 0

# 47.9
pretrained_models=logs/faster_rcnn_R_101_C4/voc2clipart_2/phase1/model_final.pth
CUDA_VISIBLE_DEVICES=0 python d_adapt.py --num-gpus 1 --confidence-ratio-c 0.1 \
  --config-file config/faster_rcnn_R_101_C4_voc.yaml \
  -s VOC2007 ../datasets/VOC2007 VOC2012 ../datasets/VOC2012  \
  -t Clipart ../datasets/clipart --test Clipart ../datasets/clipart \
  --finetune --bbox-refine \
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/voc2clipart_2/phase2 MODEL.WEIGHTS ${pretrained_models} SEED 0

# 49.0
pretrained_models=logs/faster_rcnn_R_101_C4/voc2clipart/phase2/model_final.pth
CUDA_VISIBLE_DEVICES=2 python d_adapt.py --num-gpus 1 --confidence-ratio-c 0.2 \
  --config-file config/faster_rcnn_R_101_C4_voc.yaml \
  -s VOC2007 ../datasets/VOC2007 VOC2012 ../datasets/VOC2012  \
  -t Clipart ../datasets/clipart --test Clipart ../datasets/clipart \
  --finetune --bbox-refine \
