...
CUDA_VISIBLE_DEVICES=1 python d_adapt.py --num-gpus 1 --workers-c 4 --max-train-c 20 --ignored-scores-c 0.05 0.5 --confidence-ratio-c 0.05 \
  ...
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/cityscapes2foggy_cascade_1/phase1 MODEL.WEIGHTS ${pretrained_models} SEED 0
