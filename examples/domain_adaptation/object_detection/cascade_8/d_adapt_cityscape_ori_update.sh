...
CUDA_VISIBLE_DEVICES=0 python d_adapt.py --num-gpus 1 --workers-c 4 --max-train-c 20 --ignored-scores-c 0.05 0.5 --reduce-proposals \
  ...
  OUTPUT_DIR logs/faster_rcnn_R_101_C4/cityscapes2foggy_debug_test2/phase1 MODEL.WEIGHTS ${pretrained_models} SEED 0
